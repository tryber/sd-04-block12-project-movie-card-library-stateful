...
1. Clone o repositório
  * `git clone git@github.com:tryber/sd-04-block12-project-movie-card-library-stateful.git`.
  * Entre na pasta do repositório que você acabou de clonar:
    * `cd sd-04-block12-project-movie-card-library-stateful`
...
7. Crie um novo `Pull Request` _(PR)_
  * Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-04-block12-project-movie-card-library-stateful/pulls)
