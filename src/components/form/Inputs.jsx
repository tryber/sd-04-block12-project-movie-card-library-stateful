    ...
    return [
      ...
      <label htmlFor="subtitle">Subtítulo
        <input name="subtitle" type="text" value={subtitle}
          onChange={(e) => this.props.onChange(e, 'subtitle')} />
      </label>,
      <label htmlFor="image">Imagem
        <input name="image" type="text" value={imagePath}
          onChange={(e) => this.props.onChange(e, 'imagePath')} />
      </label>,
      <label htmlFor="storyline">Sinopse
        <textarea name="storyline" type="text" value={storyline}
          onChange={(e) => this.props.onChange(e, 'storyline')} />
      </label>,
      <label htmlFor="rating">Avaliação
        <input name="rating" type="number" value={rating}
          onChange={(e) => this.props.onChange(e, 'rating')} />
      </label>,
    ];
  }
}
