  ...
  render() {
    ...
    return (
      <form>
        ...
        <input name="searchText" type="text" value={searchText} onChange={onSearchTextChange} /><br />
        <input name="bookmarkedOnly" type="checkbox" defaultChecked={bookmarkedOnly} onChange={onBookmarkedChange} />
